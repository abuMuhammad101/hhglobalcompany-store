  ...
  return (
    <main className="py-16">
      <div className="max-w-[1320px] mx-auto px-6">
        <span className="font-mono-ui text-[11px] uppercase tracking-wider text-ink-muted mb-3 block">Contact</span>
        <h1 className="text-[clamp(28px,4vw,44px)] font-medium tracking-tight mb-6">Get in touch</h1>
